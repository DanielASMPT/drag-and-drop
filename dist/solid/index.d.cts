...
type SolidState<T> = [Accessor<T>, ((items: T) => void) | ReturnType<typeof createStore>[1]];
interface SolidDragAndDropConfig<E extends Accessor<HTMLElement | null> | HTMLElement, ListItems extends unknown[]> extends Partial<ParentConfig<ListItems[number]>> {
    parent: E;
    state: SolidState<ListItems>;
}

declare function dragAndDrop<E extends HTMLElement, I>(data: SolidDragAndDropConfig<Accessor<E | null> | HTMLElement, I[]> | Array<SolidDragAndDropConfig<Accessor<E | null> | HTMLElement, I[]>>): void;
/**
 ...
 * @returns
 */
declare function useDragAndDrop<E extends HTMLElement, T = unknown>(initValues: T[], options?: Partial<ParentConfig$1<T>>): [
    Setter<E | null>,
    Accessor<Store<T[]>>,
    ReturnType<typeof createStore<T[]>>[1],
    (config?: Partial<ParentConfig$1<T>>) => void
];

export { dragAndDrop, useDragAndDrop };
